    ...
    <div id="main-nav" class="">
        <div class="container-fluid">
            <div class="nav-header">
                ...
                <a class="nav-icon-outline cart pull-right" href="#"><i class="icon-cart"></i><span class="badge">3</span></a>
            </div>
        </div>
    </div>
            ...
            <div class="col-sm-8">
                <table class="table">
                    ...
                    <tr ng:repeat="item in invoice.items">
                        <td class="vert-align"><a href="{{ item.url }}.html">{{ item.title }}</a></td>
                        <td class="vert-align">{{ item.cost | currency }}</td>
                        <td class="text-center vert-align"><input type="number" min="1" max="9" ng:model="item.qty" ng:required class="form-control form-control-inline" style="width: 52px!important;"></td>
                        <td class="text-right vert-align">{{ item.qty * item.cost | currency }}</td>
                        <td class="text-center vert-align"><a href="#" ng:click="removeItem($index)" class="remove-item"><i class="icon-close"></i></a></td>
                    </tr>
                    <!-- 							<tr>
                                                    <td></td>
                                                    <td></td>
