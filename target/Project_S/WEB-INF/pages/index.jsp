        ...
        <div class="row">
            <div class="col-sm-8">
                <a href="product1.html">
                    <img src="/resources/img/vase_1a.jpg" class="img-responsive" alt="item">
            ...
            <div class="col-sm-4">
                <a href="product2.html">
                    <img src="/resources/img/vase_2a.jpg"  class="img-responsive" alt="item">
							<span class="productlist-price-container">
								<span class="product-price">
            ...
            <div class="col-sm-4">
                <a href="product3.html">
                    <img src="/resources/img/vase_3a.jpg"  class="img-responsive" alt="item">
							<span class="productlist-price-container">
								<span class="product-price">
        ...
        <div class="row">
            <div class="col-sm-4 special">
                <div class="col-sm-12">
                    <a href="product4.html">
                        <img src="/resources/img/vase_4a.jpg"  class="img-responsive" alt="item">
								<span class="productlist-price-container">
									<span class="product-price">
                ...
                <div class="col-sm-12">
                    <a href="product5.html">
                        <img src="/resources/img/vase_5a.jpg"  class="img-responsive" alt="item">
            ...
            <div class="col-sm-8">
                <a href="product6.html">
                    <img src="/resources/img/vase_6a.jpg" class="img-responsive" alt="item">
                    <div class="productlist-label">
        ...
        <div class="row" id="more-items">
            <div class="col-sm-6">
                <a href="product7.html">
                    <img src="/resources/img/vase_7a.jpg"  class="img-responsive" alt="item">
							<span class="productlist-price-container">
								<span class="product-price">
            ...
            <div class="col-sm-6">
                <a href="product8.html">
                    <img src="/resources/img/vase_8a.jpg"  class="img-responsive" alt="item">
							<span class="productlist-price-container">
								<span class="product-price">
